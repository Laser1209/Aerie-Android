...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<void> logoutApiMobileV1AuthLogoutPost({String? authorization}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<dynamic> meApiMobileV1MeGet({String? authorization}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'authorization': authorization};
  ...
  Future<dynamic> approvalDetailApiMobileV1ApprovalsApprovalIdGet({
    ...
    final _options = _setStreamType<dynamic>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/mobile/v1/approvals/${approvalId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<dynamic> approvalDecisionApiMobileV1ApprovalsApprovalIdDecisionPost({
    required String approvalId,
    required ApprovalDecisionRequest body,
    String? authorization,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    ...
    final _options = _setStreamType<dynamic>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/mobile/v1/approvals/${approvalId}/decision',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<dynamic> ownerGuestMessagesApiMobileV1OwnerGuestsAccountIdMessagesGet({
    ...
    final _options = _setStreamType<dynamic>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/mobile/v1/owner/guests/${accountId}/messages',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<dynamic> devicesApiMobileV1DevicesGet({String? authorization}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'authorization': authorization};
  ...
  Future<dynamic> getUploadApiMobileV1FilesUploadsUploadIdGet({
    ...
    final _options = _setStreamType<dynamic>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/mobile/v1/files/uploads/${uploadId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<void> putUploadPartApiMobileV1FilesUploadsUploadIdPartsPartNumberPut({
    ...
    final _options = _setStreamType<void>(
      Options(method: 'PUT', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/mobile/v1/files/uploads/${uploadId}/parts/${partNumber}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<dynamic> completeUploadApiMobileV1FilesUploadsUploadIdCompletePost({
    ...
    final _options = _setStreamType<dynamic>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/mobile/v1/files/uploads/${uploadId}/complete',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<void> downloadFileApiMobileV1FilesFileIdContentGet({
    ...
    final _options = _setStreamType<void>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/mobile/v1/files/${fileId}/content',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<dynamic> getRequestApiMobileV1RequestsRequestIdGet({
    ...
    final _options = _setStreamType<dynamic>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/mobile/v1/requests/${requestId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<dynamic> cancelRequestApiMobileV1RequestsRequestIdCancelPost({
    ...
    final _options = _setStreamType<dynamic>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/mobile/v1/requests/${requestId}/cancel',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<dynamic> retryRequestApiMobileV1RequestsRequestIdRetryPost({
    ...
    final _options = _setStreamType<dynamic>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/mobile/v1/requests/${requestId}/retry',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
